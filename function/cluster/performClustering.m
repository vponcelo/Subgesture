...
if ~exist('results/chalearn2012/clustering/clusters.mat','file'),
    ...
    save('results/chalearn2012/clustering/clusters.mat','Ctrain');

    display('Done!');
else
    load('results/chalearn2012/clustering/clusters.mat');
end